...
- A chaque fois que quelqu'un modif le site de n'importe quel façon, il faut updater le fichier "version.txt", en montant de 0.1 la version, et en renseignant la dernière personne à avoir modif le site. (faut vraiment qu'on passe sur github sinon c'est l'enfer) 
